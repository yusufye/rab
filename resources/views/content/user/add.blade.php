...
@section('content')
<form action="{{url('user/submit')}}" method="POST" id="form-create-user">
    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="text" class="form-control required-field" id="nip" placeholder="{{ __('NIP') }}"
                                    name="nip" aria-label="NIP" required value="{{ old('nip') }}" data-required="NIP" maxlength="50">
                        ...
                        <div class="col-6">
                            <div class="form-floating form-floating-outline">
                                ...
                                name="name" aria-label="name" required value="{{ old('name') }}" data-required="Name" maxlength="255">
                        ...
                        <div class="col-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="email" class="form-control required-field" id="email" placeholder="{{ __('Email') }}"
                                    name="email" aria-label="Email" required value="{{ old('email') }}" data-required="NIP" maxlength="255">
                                <label for="email" class="required">{{ __('Email') }}</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="password" class="form-control required-field" id="password" placeholder="{{ __('Password') }}"
                                    name="password" aria-label="password" required value="{{ old('password') }}" data-required="Password" maxlength="255">
