...
<!-- END: Page Vendor JS-->
 ...
 <script type="module" src="{{asset('assets/vendor/libs/jquery-repeater/jquery-repeater.js')}}"></script>
 <script type="module" src="{{asset('assets/vendor/libs/moment/moment.js')}}"></script>
